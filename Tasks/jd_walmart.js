 ...
 * @Last Modified time: 2021-02-17 14:00:00
 */
...
function grantTokenKey() {
  let opt = {
    ...
    headers: {
      ...
      'Cookie': cookie,
      'User-Agent': 'JD4iPhone/9.4.1 CFNetwork/1236 Darwin/20.4.0',
...
function getActCookie() {
  let opt = {
    ...
    headers: {
      ...
      'Connection': 'keep-alive',
      'Cookie': `${cookie}`,
      'User-Agent': 'jdapp;iPhone;9.4.1;14.5;bf1f9a94239880f59a8f3b018a3aadf380e216fc;network/wifi;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone10,3;addressid/1065702877;supportBestPay/0;appBuild/167548;jdSupportDarkMode/0;pv/425.7;apprpd/Babel_Native;ref/TTTChannelViewContoller;psq/6;ads/;psn/bf1f9a94239880f59a8f3b018a3aadf380e216fc|485;jdv/0|iosapp|t_335139774|appshare|CopyURL|1613011294448|1613011296;adk/;app_device/IOS;pap/JA2015_311210|9.4.1|IOS 14.5;Mozilla/5.0 (iPhone; CPU iPhone OS 14_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
      'Accept-Language': 'en-US;q=1, zh-Hans-US;q=0.9',
      'Accept-Encoding': 'gzip, deflate, br',
    }
  }
  ...
  return new Promise(async resolve => {
    const options = {
      ...
      "headers": {
        ...
        "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : "jdapp;iPhone;9.4.1;14.5;bf1f9a94239880f59a8f3b018a3aadf380e216fc;network/wifi;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone10,3;addressid/1065702877;supportBestPay/0;appBuild/167548;jdSupportDarkMode/0;pv/425.7;apprpd/Babel_Native;ref/TTTChannelViewContoller;psq/6;ads/;psn/bf1f9a94239880f59a8f3b018a3aadf380e216fc|485;jdv/0|iosapp|t_335139774|appshare|CopyURL|1613011294448|1613011296;adk/;app_device/IOS;pap/JA2015_311210|9.4.1|IOS 14.5;Mozilla/5.0 (iPhone; CPU iPhone OS 14_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1") : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;9.4.1;14.5;bf1f9a94239880f59a8f3b018a3aadf380e216fc;network/wifi;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone10,3;addressid/1065702877;supportBestPay/0;appBuild/167548;jdSupportDarkMode/0;pv/425.7;apprpd/Babel_Native;ref/TTTChannelViewContoller;psq/6;ads/;psn/bf1f9a94239880f59a8f3b018a3aadf380e216fc|485;jdv/0|iosapp|t_335139774|appshare|CopyURL|1613011294448|1613011296;adk/;app_device/IOS;pap/JA2015_311210|9.4.1|IOS 14.5;Mozilla/5.0 (iPhone; CPU iPhone OS 14_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1")
      }
    }
