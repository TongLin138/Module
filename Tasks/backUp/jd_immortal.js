 ...
 * @Last Modified time: 2021-01-31 21:00:00
 */
...
const randomCount = 0;
let scoreToBeans = $.isNode()?(process.env.JD_IMMORTAL_SCORE || 1000):$.getdata('scoreToBeans') || 1000; //兑换多少数量的京豆（20或者1000），0表示不兑换，默认兑换20京豆，如需兑换把0改成20或者1000，或者'商品名称'(商品名称放到单引号内)即可
