 ...
 * @Last Modified time: 2021-01-25 14:00:00
 */
...
function taskPostUrl(function_id, body = {}, function_id2) {
  ...
  return {
    ...
    headers: {
      ...
      'Content-Type': 'application/x-www-form-urlencoded',
      "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;iPhone;9.3.7;14.3;bf1f9a94239880f59a8f3b018a3aadf380e216fc;network/wifi;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone10,3;addressid/1065702877;supportBestPay/0;appBuild/167536;jdSupportDarkMode/0;pv/894.2;apprpd/Home_Main;ref/JDMainPageViewController;psq/1;ads/;psn/bf1f9a94239880f59a8f3b018a3aadf380e216fc|1046;jdv/0|iosapp|t_335139774|appshare|Wxfriends|1611557944653|1611557947;adk/;app_device/IOS;pap/JA2015_311210|9.3.7|IOS 14.3;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1")
    }
  }
}
function TotalBean() {
