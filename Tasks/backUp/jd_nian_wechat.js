 ...
 * @Last Modified time: 2021-01-21 21:00:00
 */
...
function taskUrl(function_id, body = {}) {
  ...
  return {
    ...
    headers: {
      ...
      "User-Agent": $.isNode() ? (process.env.JD_WECHAT_USER_AGENT ? process.env.JD_WECHAT_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUAWECHAT') ? $.getdata('JDUAWECHAT') : "Mozilla/5.0 (iPhone; CPU iPhone OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.1(0x18000123) NetType/WIFI Language/en")
    }
  }
}
